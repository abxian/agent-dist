...
<#
ScreenAgent 安装 / 手动升级脚本 (国内源版本, 默认 -Source cn)
用法:
    ...
    powershell -ExecutionPolicy Bypass -File .\install-screenagent-cn.ps1 -ServerIp sx1.jc116.com -ServerPort 9999
